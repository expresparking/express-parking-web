...
export default function ConnectPage() {
  const shareCard = async () => {
    const data = {
      title: "Nebyat Shewaye | Express Parking & Mobility",
      text: "Nebyat Shewaye, CEO — Express Parking & Mobility",
  ...
  return (
    <main style={{minHeight:"100vh",background:"#f5f5f3",display:"grid",placeItems:"center",padding:"18px",fontFamily:"Inter,Arial,Helvetica,sans-serif",color:"#191b1f"}}>
      <section style={{width:"min(100%,420px)",background:"#fff",border:"1px solid #ececea",borderRadius:28,padding:"29px 23px 20px",boxShadow:"0 14px 40px rgba(0,0,0,.06)",textAlign:"center"}}>
        <div style={{fontSize:66,lineHeight:.9,fontWeight:700,color:"#ff5a00",letterSpacing:-7}}>X</div>
        <div style={{fontSize:29,fontWeight:600,letterSpacing:4,marginTop:10}}>EXPRESS</div>
        ...
        <div style={{marginTop:17}}>
          <div style={{fontSize:10.5,letterSpacing:1.5,color:"#666",marginBottom:10}}>SHARE CONTACT</div>
          <button onClick={shareCard} style={{color:"#ff5a00",border:"1px solid #f0c6ae",borderRadius:12,padding:"11px 18px",fontSize:12,fontWeight:500,background:"#fff",cursor:"pointer"}}>Share this card</button>
        </div>
